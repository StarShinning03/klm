HELP_1 = """<b>Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Aᴅᴍɪɴs Mᴏᴅᴜʟᴇ :</b>
─────────────────────

bash start<u>Aᴅᴍɪɴ Cᴏᴍᴍᴀɴᴅs :</b></u>
...
HELP_2 = """
<b>Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Aᴜᴛʜ Mᴏᴅᴜʟᴇ :</b>
─────────────────────
...
HELP_3 = """
<b>Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Bʀᴏᴀᴅᴄᴀsᴛ Mᴏᴅᴜʟᴇ :</b>
─────────────────────

<u><b>Bʀᴏᴀᴅᴄᴀsᴛ Fᴇᴀᴛᴜʀᴇ</b></u> [ᴏɴʟʏ ғᴏʀ sᴜᴅᴏᴇʀs] :
...
HELP_4 = """<b>Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Bʟ-Cʜᴀᴛ Mᴏᴅᴜʟᴇ :</b>
─────────────────────

<u><b>Cʜᴀᴛ Bʟᴀᴄᴋʟɪsᴛ Fᴇᴀᴛᴜʀᴇ :</b></u> [ᴏɴʟʏ ғᴏʀ sᴜᴅᴏᴇʀs]
...
HELP_5 = """
<b>Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Bʟᴀᴄᴋʟɪsᴛ Mᴏᴅᴜʟᴇ :</b>
─────────────────────

<u><b>Bʟᴏᴄᴋ Usᴇʀs:</b></u> [ᴏɴʟʏ ғᴏʀ sᴜᴅᴏᴇʀs]
...
HELP_6 = """
<b>Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ C-Pʟᴀʏ Mᴏᴅᴜʟᴇ :</b>
─────────────────────

<u><b>Cʜᴀɴɴᴇʟ Pʟᴀʏ Cᴏᴍᴍᴀɴᴅs:</b></u>
...
HELP_7 = """
<b>Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ G-ʙᴀɴ Mᴏᴅᴜʟᴇ :</b>
─────────────────────

<u><b>Gʟᴏʙᴀʟ Bᴀɴ Fᴇᴀᴛᴜʀᴇ</b></u> [ᴏɴʟʏ ғᴏʀ sᴜᴅᴏᴇʀs] :
...
HELP_8 = """
<b>Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Lᴏᴏᴘ Mᴏᴅᴜʟᴇ :</b>
─────────────────────
...
HELP_9 = """
<b>Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Mᴀɪɴᴛᴇɴᴀɴᴄᴇ Mᴏᴅᴜʟᴇ :</b>
─────────────────────

<u><b>Mᴀɪɴᴛᴇɴᴀɴᴄᴇ Mᴏᴅᴇ</b></u> [ᴏɴʟʏ ғᴏʀ sᴜᴅᴏᴇʀs] :
...
HELP_10 = """
<b>Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Pɪɴɢ Mᴏᴅᴜʟᴇ :</b>
─────────────────────
...
HELP_11 = """
<b>Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Pʟᴀʏ Mᴏᴅᴜʟᴇ :</b>
─────────────────────

<u><b>Pʟᴀʏ Cᴏᴍᴍᴀɴᴅs :</b></u>
...
HELP_12 = """
<b>Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Sʜᴜғғʟᴇ Mᴏᴅᴜʟᴇ :</b>
─────────────────────

<b><u>Sʜᴜғғʟᴇ Qᴜᴇᴜᴇ :</b></u>
...
HELP_13 = """
<b>Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Sʜᴇᴇᴋ Mᴏᴅᴜʟᴇ :</b>
─────────────────────
...
HELP_14 = """
<b>Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Sᴏɴɢ Mᴏᴅᴜʟᴇ :</b>
─────────────────────
...
HELP_15 = """
<b>Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Sᴘᴇᴇᴅ Mᴏᴅᴜʟᴇ :</b>
─────────────────────
